...
@IDSFunction(name="evaluasi", arguments={"code": str}, annotation=Any)
def _evaluasi(code: str) -> Any:
    return eval(code, namespace)


@IDSFunction(name="jalankan", arguments={"code": str}, annotation=None)
def _jalankan(code: str) -> None:
    exec(code, namespace)


@IDSFunction(name="impor", arguments={"module": str}, annotation=Any)
...
@IDSFunction(name="ambil", arguments={"nama": str}, annotation=Any)
def _ambil(nama: str) -> Any:
    return namespace[nama]


@IDSFunction(name="atur", arguments={"nama": str, "nilai": Any}, annotation=None)
def _atur(nama: str, nilai: Any) -> None:
    namespace[nama] = unwrap_py_value(nilai)


@IDSFunction(name="hapus", arguments={"nama": str}, annotation=None)
def _hapus(nama: str) -> None:
    namespace.pop(nama, None)


@IDSFunction(name="punya", arguments={"nama": str}, annotation=bool)
def _punya(nama: str) -> bool:
    return nama in namespace


@IDSFunction(name="daftar", arguments={}, annotation=list)
def _daftar() -> list:
    return sorted(namespace)


@IDSFunction(name="bersihkan", arguments={}, annotation=None)
def _bersihkan() -> None:
    namespace.clear()
...
@IDSFunction(name="pengingatan", arguments={"fungsi": Any, "args": list}, annotation=Any)
def _pengingatan(fungsi: Any, args: list) -> Pengingatan:
    return Pengingatan(fungsi, args)


@IDSFunction(name="penungguan", arguments={"nilai": Any}, annotation=Any)
def _penungguan(nilai: Any) -> Any:
    return wrap_py_value(_run_awaitable(nilai))


@IDSModule(name="Python", path=Path(__file__).with_suffix(".idsm"))
def module(cls):
    cls.add(
        _evaluasi,
        _jalankan,
